...
public class Checking extends Account {
	...
	public String toString() {
		System.out.printf("%12s %-55s %12.2f %s %10d %3s %12.2f %6s %12.2f %s", "Checking", this.getCustomer(), this.getAccountBalance(), "", this.getNumberOfTransactions(), "", this.getCheckingTransactionFee(), "", this.getCheckingTransactionFeeAmount(),"\n");
		return "    ";
	}
}
/*
